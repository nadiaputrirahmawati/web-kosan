    ...
    @forelse ($Room as $data)
        <div class="bg-white shadow-sm rounded-xl p-3 mt-2">
            <div class="flex justify-between w-full">
                <div class="flex">
                    <img src="{{ asset('img/simcard.png') }}" alt="" class="w-20 object-cover">
                    <div class="mt-4">
                        <h1 class="font-bold">{{ $data->name }}</h1>
                        <h1 class="capitalize text-xs font-semibold"><i class="fa-light fa-users mr-1"></i> {{ $data->type }}</h1>
                
                    </div>
                </div>
                <div class="mt-4">
                    <a href="/owner/room/{{ $data->room_id }}/show" class="bg-black px-3 font-bold rounded-lg py-2 text-white text-sm">
                        Manage
                    </a>
                </div>
            </div>
            ...
            <div class="flex space-x-3 justify-between ">
                <div class="flex">
                    <div class="flex">
                        <div>
                            <i class="fa-light fa-money-bill-wave mr-2 bg-base text-primary lg:px-3 lg:py-2 px-3 py-2 rounded-lg lg:text-sm text-xs"></i>
                        </div>
                         <div>
                ...
                <div class="flex">
                    <div class="flex">
                        <div>
                            <i class="fa-light fa-door-open mr-2 bg-blue-100 text-blue-900 lg:px-3 lg:py-2 px-3 py-2 rounded-lg lg:text-sm text-xs"></i>
                        </div>
                         <div>
                ...
                <div class="flex">
                    <div class="flex">
                        <div>
                            <i class="fa-light fa-wallet mr-2 bg-orange-50 text-orange-900 lg:px-3 lg:py-2 px-3 py-2 rounded-lg lg:text-sm text-xs"></i>
                        </div>
                         <div>
