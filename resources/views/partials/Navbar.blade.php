<div x-data="{ isSidebarOpen: false, isProfileMenuOpen: false }" class="relative">
    ...
    <header class="z-10 py-4 bg-transparent ">
        <div class="container flex items-center justify-between  h-full lg:px-16 px-10 mx-auto text-purple-600">
            <!-- Buka Tutup Icons -->
            <button @click="isSidebarCollapsed = !isSidebarCollapsed"
                class="p-1 mr-5 -ml-10 hidden lg:flex rounded-md focus:outline-none focus:shadow-outline-purple">
                <i class="fa-solid fa-bars text-2xl"></i>
            </button>
            <!-- Mobile hamburger -->
            <button @click="isSidebarOpen = !isSidebarOpen"
                class="p-1 mr-5 -ml-4 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple">
                <i class="fa-solid fa-bars text-2xl"></i>
            </button>
            <!-- Profile menu -->
